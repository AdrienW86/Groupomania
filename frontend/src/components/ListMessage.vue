                   ...
                   <div class="card-header">
                      ...
                      <div class="card_body">                                                                                                    
                            <form enctype="mmultipart/form-data">
                              <textarea v-model="comment.content" type="textarea" rows="2"  name="comment" placeholder="Votre commentaire, agrandissez la fenêtre" class="comment-input"> </textarea>
                         ...
                         <p> {{message.createdAt}} </p>
                              <div class="box-btn">
                                ...
                                @click="like(message.id);">
                                  <svg xmlns="http://www.w3.org/2000/svg" 
                                    width="22" height="22" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                            ...
                            <button 
                                ...
                                @click="dislike(message.id)"> 
                                  <svg xmlns="http://www.w3.org/2000/svg" 
                                     width="22" height="22" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
